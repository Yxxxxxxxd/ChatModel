/**
 * Created by NM-173 on 2018/9/3.
 */
    // Log.info("logging info: " ,JSON.stringify(this.liveHallTabs));
    // Log.warn("log warn： " + "oh no ");
    // Log.error("log error: " + "hahhhhhhhhh");
    // Log.debug("DEBUG "+JSON.stringify(this.liveHallTabs));
var consoleId = window.localStorage.consoleId;
// consoleId = JSON.parse(consoleId);
