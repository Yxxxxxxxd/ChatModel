/**
 *  The reason why use this source is
 *  'new WebSocket()' to 'new ReconnectingWebSocket()' in line 5223
 */
...
Strophe.Websocket.prototype = {
    ...
    _connect: function () {
        ...
        //this.socket = new ReconnectingWebSocket(this._conn.service, "xmpp", {reconnectInterval: 3000,  timeoutInterval : 180000,  maxReconnectAttempts : 100});  //new WebSocket(this.url, "xmpp");
    ...
    _onMessage: function(message) {
        ...
        if (message.data === close) {
            ...
            data = funcReplaceInvalidChat(data);
