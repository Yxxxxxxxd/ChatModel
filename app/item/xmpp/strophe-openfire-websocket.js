...
Openfire.Connection.prototype = {
    ...
    connect: function (jid, password, resourceId, callback)
    {       
        ...
        //this.url = this.url + "?username=" + this.username + "&password=" + this.password + "&resource=showspace_H_7.6.0_" + 7001175;

        this.url = this.url + "?username=" + this.username + "&password=" + this.password + "&resource=" + resourceId;
        this._ws = new ReconnectingWebSocket(this.url, "xmpp", {reconnectInterval: 3000,  timeoutInterval : 10000,  maxReconnectAttempts : 100});  //new WebSocket(this.url, "xmpp");
